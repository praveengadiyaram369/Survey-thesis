...
async def keyword_search(request: Request, query: int=Form(1), sub_topic_selected: int=Form(1), lang: int=Form(1), phrase_query: bool=Form(False), search_concept: bool=Form(False), match_top: str=Form(...), fuzzy_query: str=Form(False), search_type: str=Form(...)):
    ...
    return templates.TemplateResponse('sub_topic_search.html', context={'request': request,'session_id': session_id, 'total_hits': total_hits, 'result_list': results, 'concept_list': [], 'query': query, 'search_data':search_data, 'sub_topic_list':sub_topic_list})
...
async def keyword_search(request: Request, query: str=Form(...), sub_topic_selected: int=Form(1)):
    ...
    return templates.TemplateResponse('search_survey.html', context={'request': request,'session_id': session_id, 'total_hits': total_hits, 'result_list_1': system_a_results, 'result_list_2': system_b_results, 'concept_list': [], 'query': query, 'search_data':search_data, 'sub_topic_list':sub_topic_list, 'query_keyword_list': query_keyword_list})
