...
async def validate_technology(request: Request):
    ...
    global document_data, document_type, relevant_document_data, irrelevant_document_data
    document_type = 'technology'
    document_data, relevant_document_data, irrelevant_document_data = load_document_data(type=document_type)
...
async def mark_documents_irrelevant(request: Request, irrelevant_page_id: str=Form(1)):
    ...
    update_document_data(irrelevant_page_id, type='irrelevant')
...
def update_document_data(page_id, type):

    global document_data, relevant_document_data, irrelevant_document_data
    ...
    if type == 'irrelevant':
        ...
        relevant_document_data[page_id] = page_id_data

    save_document_data(document_data, relevant_document_data, irrelevant_document_data, type=document_type)
